...
type LongRunningActivityHandlerFunc func(activityTask *swf.PollForActivityTaskOutput, input interface{})
...
func NewLongRunningActivityHandler(activity string, handler interface{}) *LongRunningActivityHandler {
	...
	typeCheck(handler, []string{"*swf.PollForActivityTaskOutput", input.String()}, []string{})
